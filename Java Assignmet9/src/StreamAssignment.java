...
public class StreamAssignment {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
			...
			List<Friut> list2=Arrays.asList(
					new Friut("Mango",100,60,"Yellow"),
					new Friut("Banana",50,30,"Yellow"),
					new Friut("Orange",78,60,"Orange"),
					new Friut("Guava",88,60,"Brown"),
					new Friut("Apple",60,117,"Red")
					
					);
			Trader trader1=new Trader("Chetan","Sangli");
			Trader trader2=new Trader("Abc","Pune");
			Trader trader3=new Trader("Xyz","Mumbai");
			Trader trader4=new Trader("Qwe","Pune");
